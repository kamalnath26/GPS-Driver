...
bag_file = os.path.join(current_path,'stationary_on_building_open.bag')
# bag_file = os.path.join(current_path,'stationary_on_building_open2.bag')
...
altitudes, timestamps = read_bag_data_altitude(bag_file)
...
print(f'Min Altitude on top of open Building: {np.min(altitudes):.2f} m')
print(f'Max Altitude on top of open Building: {np.max(altitudes):.2f} m')
print(f'Mean Altitude on top of open Building: {np.mean(altitudes):.2f} m')
...
plt.title('Stationary Northing vs. Easting Scatterplot On Building')
...
plt.figure()
plt.plot(timestamps, altitudes, marker='o', linestyle='-', color='red', label='Altitude vs. Time on top of open Building')
plt.title('Altitude vs. Time on top of open Building')
